...
local MainAssetFolder = IsLocal and ReplicatedStorage.Caffeine
or InsertService:LoadLocalAsset("rbxassetid://12727621682")
...
function Assets:Screen() local ScreenAsset = GetAsset("Screen/Caffeine")
	if not IsLocal then sethiddenproperty(ScreenAsset,"OnTopOfCoreBlur",true) end
	ScreenAsset.Name = "Caffeine " .. game:GetService("HttpService"):GenerateGUID(false)
...
local Caffeine = Assets:Screen()
function Caffeine:Window(Window)
	...
	local WindowAsset = Assets:Window(Caffeine.ScreenAsset,Window)

	function Window:Tab(Tab)
		Tab = GetType(Tab,{},"table",true)
		Tab.Name = GetType(Tab.Name,"Tab","string")
		local TabAsset = Assets:Tab(Caffeine.ScreenAsset,WindowAsset,Window,Tab)
		...
		function Tab:Button(Button)
			...
			Assets:Button(ChooseTabSide(TabAsset,Button.Side),Caffeine.ScreenAsset,Window,Button)
			return Button
		end
		function Tab:Toggle(Toggle)
			...
			local ToggleAsset = Assets:Toggle(ChooseTabSide(TabAsset,Toggle.Side),Caffeine.ScreenAsset,Window,Toggle)
			function Toggle:Keybind(Keybind)
				...
				Assets:ToggleKeybind(ToggleAsset.Layout,Caffeine.ScreenAsset,Window,Keybind,Toggle)
				return Keybind
			end
			function Toggle:Colorpicker(Colorpicker)
				...
				Assets:ToggleColorpicker(ToggleAsset.Layout,Caffeine.ScreenAsset,Window,Colorpicker)
				return Colorpicker
			end
			return Toggle
		end
		function Tab:Slider(Slider)
			...
			Assets:Slider(ChooseTabSide(TabAsset,Slider.Side),Caffeine.ScreenAsset,Window,Slider)
			return Slider
		end
		function Tab:Textbox(Textbox)
			...
			Assets:Textbox(ChooseTabSide(TabAsset,Textbox.Side),Caffeine.ScreenAsset,Window,Textbox)
			return Textbox
		end
		function Tab:Keybind(Keybind)
			...
			Assets:Keybind(ChooseTabSide(TabAsset,Keybind.Side),Caffeine.ScreenAsset,Window,Keybind)
			return Keybind
		end
		function Tab:Dropdown(Dropdown)
			...
			Assets:Dropdown(ChooseTabSide(TabAsset,Dropdown.Side),Caffeine.ScreenAsset,Window,Dropdown)
			return Dropdown
		end
		function Tab:Colorpicker(Colorpicker)
			...
			Assets:Colorpicker(ChooseTabSide(TabAsset,Colorpicker.Side),Caffeine.ScreenAsset,Window,Colorpicker)
			return Colorpicker
		end
		function Tab:Section(Section)
			...
			function Section:Button(Button)
				...
				Button.Name = GetType(Button.Name,"Button","string")
				Button.Callback = GetType(Button.Callback,function() end,"function")
				Assets:Button(SectionContainer,Caffeine.ScreenAsset,Window,Button)
				return Button
			end
			function Section:Toggle(Toggle)
				...
				local ToggleAsset = Assets:Toggle(SectionContainer,Caffeine.ScreenAsset,Window,Toggle)
				function Toggle:Keybind(Keybind)
					Keybind = GetType(Keybind,{},"table",true)
					Keybind.Flag = GetType(Keybind.Flag,Toggle.Flag .. "/Keybind","string")
			...
			function Section:Slider(Slider)
				...
				Assets:Slider(SectionContainer,Caffeine.ScreenAsset,Window,Slider)
				return Slider
			end
			function Section:Textbox(Textbox)
				...
				Assets:Textbox(SectionContainer,Caffeine.ScreenAsset,Window,Textbox)
				return Textbox
			end
			function Section:Keybind(Keybind)
				...
				Assets:Keybind(SectionContainer,Caffeine.ScreenAsset,Window,Keybind)
				return Keybind
			end
			function Section:Dropdown(Dropdown)
				...
				Assets:Dropdown(SectionContainer,Caffeine.ScreenAsset,Window,Dropdown)
				return Dropdown
			end
			function Section:Colorpicker(Colorpicker)
				...
				Assets:Colorpicker(SectionContainer,Caffeine.ScreenAsset,Window,Colorpicker)
				return Colorpicker
			end
			return Section
		end
...
function Caffeine:Notification(Notification)
	...
	NotificationAsset.Parent = Caffeine.ScreenAsset.NDHandle
...
function Caffeine:Notification2(Notification)
	Notification = GetType(Notification,{},"table")
	Notification.Title = GetType(Notification.Title,"Title","string")
	...
	NotificationAsset.Parent = Caffeine.ScreenAsset.NLHandle
