...
if not Workspace:FindFirstChild("Bots") then
    RobloxRage.Utilities.UI:Notification({Title = "I Miss The Rage",Description = "Join game first",Duration = 5})
    return
end
...
local Window = RobloxRage.Utilities.UI:Window({
    ...
    end RobloxRage.Utilities:SettingsSection(Window,"RightShift",true)
...
for Index,Item in pairs(RaycastFolder:GetChildren()) do
    if Item:FindFirstChildWhichIsA("ProximityPrompt",true) then
        RobloxRage.Utilities.Drawing:AddObject(Item,Item.Name,Item.PrimaryPart,"ESP/Intel","ESP/Intel",Window.Flags)
    end
end
